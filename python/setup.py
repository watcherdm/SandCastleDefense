...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "SandCastleDefense.py"
 
        #Name of program
        self.project_name = "SandCastleDefense"
 
        #Project url
        self.project_url = "www.sandcastledefensegame.com"
 
        #Version of program
        self.project_version = "0.0.2"
 
        #License of the program
        self.license = "Apache License"
 
        #Auhor of program
        self.author_name = "Gabriel Hernandez"
        self.author_email = "webspinner.gabriel@gmail.com"
        self.copyright = "Copyright (c) 2013 Game Change Studios."
 
        #Description
        self.project_description = "Sand Castle Defense"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "scd.ico"
